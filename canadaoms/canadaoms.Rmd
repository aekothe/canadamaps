...
Here's some Canadian maps made with Open Street Maps. It includes Toronto, Montreal, and Vancouver.



```{r toronto, echo=FALSE, fig.keep='last', message=FALSE, results='hide'}
library(remotes)
library(sf)
...
Here's a map of bars, pubs, breweries, and liquor stores in Toronto. In blue, purple, yellow, and orange respectively.



```{r bars, echo=FALSE, echo=FALSE, fig.keep='last', message=FALSE, results='hide'}
#alcohol map
liquor <- toronto%>%
  opq()%>%
...
```{r montreal, echo=FALSE, fig.keep='last', message=FALSE, results='hide'}
...
```{r bakeries, echo=FALSE, fig.keep='last', message=FALSE, results='hide'}
bakeries <- montreal%>%
  opq()%>%
...
Here's a map of Vancouver.




```{r vancouver, echo=FALSE, fig.keep='last', message=FALSE, results='hide'}
...
Here's a map of seafood shops, or places that focus on selling fish in Vancouver.




```{r seafood, echo=FALSE, fig.keep='last', message=FALSE, results='hide'}
#vancouver seafood
seafood <- vancouver%>%
  opq()%>%
