...
#Calgary
calridings <- read_csv(file="/Users/annkothe/desktop/r/mapcan/calgary.csv")
...
#Edmonton
edridings <- read_csv(file="/Users/annkothe/desktop/r/mapcan/edmonton.csv")
...
#Winnipeg
winnipeg <- read_csv(file="/Users/annkothe/desktop/r/mapcan/winnipeg.csv")
...
#London
londonridings <- read_csv(file="/Users/annkothe/desktop/r/mapcan/london.csv")
london <- left_join(londonridings, map2019, by = "riding_name_english")
round(london$pctVote, digits = 0)
...
#Windsor
windsorridings <- read_csv(file="/Users/annkothe/desktop/r/mapcan/windsor.csv")
...
#Hamilton Niagara
niagararidings <- read_csv(file="/Users/annkothe/desktop/r/mapcan/hamiltonniagara.csv")
...
#Quebec City
quebec <- read_csv(file="/Users/annkothe/desktop/r/mapcan/quebeccity.csv")
...
#Regina
regina <- read_csv(file="/Users/annkothe/desktop/r/mapcan/regina.csv")
...
#Saskatoon
saskatoon <- read_csv(file="/Users/annkothe/desktop/r/mapcan/saskatoon.csv")
